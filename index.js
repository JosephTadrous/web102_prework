...
const unfundedNum = GAMES_JSON.reduce((acc, game) => {
...
const displayStr = 
`A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length - unfundedNum} ${GAMES_JSON.length - unfundedNum > 1 ? "games" : "game"}. 
Currently, ${unfundedNum} ${unfundedNum > 1 ? "games" : "game"} remains unfunded. 
